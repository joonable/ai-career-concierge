...
from db.repositories import JobRepository, SystemLogRepository
        ...
        for source in self.scraper_registry.sources:
            try:
                ...
                for scraped_job in scraped_jobs:
                    ...
                    stored_job = self.job_repository.upsert_job(normalized_job)
                    current_jobs.append(PipelineJob.from_job_model(stored_job))
