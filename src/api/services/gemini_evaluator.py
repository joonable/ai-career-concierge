...
class GeminiEvaluator:
    ...
    async def evaluate(
        ...
        *,
        ...
        parsed_payload["_raw_response_text"] = response_text
    ...
    def _parse_json_response(text: str) -> Dict[str, Any]:
        try:
            ...
            raise ProviderResponseParseError("Gemini response was not valid JSON.") from exc

        if not isinstance(parsed, dict):
            raise ProviderResponseParseError("Gemini response JSON must be an object.")
        return parsed
