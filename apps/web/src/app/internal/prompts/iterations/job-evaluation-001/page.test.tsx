...
import PromptOpsIterationDetailPage from "@/app/internal/prompts/iterations/job-evaluation-001/page";
...
describe("PromptOpsIterationDetailPage", () => {
  ...
  it("renders the iteration summary and follow-up actions", async () => {
    ...
    expect(screen.getByText("프롬프트 운영 패널로 돌아가기")).toBeInTheDocument();
